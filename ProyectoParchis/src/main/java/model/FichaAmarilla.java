 ...
 */
public class FichaAmarilla {
    Dado dado = new Dado();
    
    private Coordenadas[] camino;
    private int indice;
    
    
    public FichaAmarilla(){
    
        camino = new Coordenadas[]{
        ...
        new Coordenadas(198, 26),
        new Coordenadas(198, 49),
        new Coordenadas(197, 73),
        ...
        */
        ...
        new Coordenadas(255, 490),
        new Coordenadas(255, 467),
        new Coordenadas(254, 442),
        new Coordenadas(254, 418),
        new Coordenadas(254, 394),
        new Coordenadas(254, 370),
        new Coordenadas(254, 344),
        new Coordenadas(254, 287)
    ...
    public Coordenadas getPosicionAmarilla(){
    
        return camino[indice];
        
    }
    
    public void AvanzarAmarilla(){
    
         if (indice<camino.length-1){
            
            dado.lanzarDado();
            
            indice=indice+dado.getDado();
